/**
 * Ad Set Detail Page - DEPRECATED
 * ================================
 *
 * WHAT: Redirects to main campaigns page
 * WHY: Ad set details now shown in modal on the main campaigns page
 *
 * This page is kept for backwards compatibility with existing bookmarks/links.
 * The CampaignDetailModal on /campaigns now handles all campaign/adset detail views.
 *
...
export default function DeprecatedAdSetDetailPage() {
    ...
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="text-center">
        ...
        <p className="text-slate-400 text-xs mt-2">
          Ad set details are now shown in a modal on the campaigns page.
        </p>
      </div>
    </div>
  );
