 ...
 *
 * WHAT: Renders Clerk's SignUp component with custom styling
 * WHY: New users can create accounts (workspace created via webhook)
 *
 ...
 *
 * Note: After sign-up, Clerk triggers a webhook that creates:
 * - User record in our database
 * - Default workspace ("FirstName's Workspace")
 * - WorkspaceMember record
 *
 * REFERENCES:
 *   - https://clerk.com/docs/components/authentication/sign-up
 *   - backend/app/routers/clerk_webhooks.py (user.created handler)
 */
